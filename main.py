...
async def ban_command(ctx, member: discord.Member, reason: str = "無し", deleteMessageDays: int = 0):
    ...
    await ctx.send(embed=managelog(member.display_name,ctx.author.mention,"BAN",reason))
...
async def ban_command(ctx, member: discord.Member, reason: str = "無し", deleteMessageDays: int = 0):
    ...
    await member.ban(reason=reason,delete_message_days=deleteMessageDays)
    await ctx.send(embed=managelog(member.display_name,ctx.author.mention,"グローバルBAN",reason))
...
async def kick_command(ctx, member: discord.Member, reason: str = "無し"):
    ...
    await ctx.send(embed=managelog(member.display_name,ctx.author.mention,"kick",reason))
...
async def unban_command(ctx, member: discord.User, reason: str = "無し"):
    ...
    await ctx.send(embed=managelog(member.display_name,ctx.author.mention,"unBAN",reason))
...
class manageMember(app_commands.Group):
    ...
    async def ban(self, interaction: discord.Interaction, member: discord.Member, reason: str = "無し", days: int = 0):
        ...
        await interaction.response.send_message(embed=managelog(member.display_name,ctx.author.mention,"BAN",reason))
    ...
    async def gban(self, interaction: discord.Interaction, member: discord.Member, reason: str = "無し", days: int = 0):
        ...
        await member.ban(reason=reason,delete_message_days=days)
        await interaction.response.send_message(embed=managelog(member.display_name,ctx.author.mention,"グローバルBAN",reason))
    ...
    async def kick(self, interaction: discord.Interaction, member: discord.Member, reason: str = "無し"):
        await member.kick(reason=reason)
        await interaction.response.send_message(embed=managelog(member.display_name,ctx.author.mention,"kick",reason))
    ...
    async def unban(self, interaction: discord.Interaction, member: discord.User, reason: str = "無し"):
        ...
        await interaction.response.send_message(embed=managelog(member.display_name,ctx.author.mention,"unBAN",reason))
